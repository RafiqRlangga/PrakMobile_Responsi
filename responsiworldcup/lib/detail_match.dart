...
import 'package:responsiworldcup/detail_matches_model.dart';
  ...
  Widget _buildSuccessSection (DetailMatchesModel data) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5,),
        Text("${data.homeTeam?.name} VS ${data.awayTeam?.name}"),
        SizedBox(height: 10,),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5,),
              Text("${data.homeTeam?.statistics?.passesCompleted}   Pass Accuracy   ${data.awayTeam?.statistics?.attemptsOnGoal}"),
            ],
          ),
        ),
        SizedBox(height: 5,),
